 ...
 *       &lt;sequence>
 *         &lt;element name="property" type="{http://openprovenance.org/model/v1.1.a}Property" maxOccurs="unbounded"/>
...
@XmlType(name = "EmbeddedAnnotation", propOrder = {
    "property",
    "account",
    "annotation"
})
public class EmbeddedAnnotation implements HasAccounts, Annotable, Serializable {
